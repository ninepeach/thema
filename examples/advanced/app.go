...
func (app *application) routes() http.Handler {
	...
	mux.HandleFunc("GET /my-stays", app.myStays)
	mux.HandleFunc("GET /stay-information", app.stayInformation)
	mux.HandleFunc("GET /cancellation-policy", app.cancellationPolicy)
	mux.HandleFunc("GET /privacy", app.privacy)
